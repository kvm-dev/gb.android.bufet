    ...
    private fun searchFoodByKeyWord(){
        binding.search.doOnTextChanged { text, _, _, _ ->
            ...
            if (viewModel.currentRestaurants.value.isNullOrEmpty()) {
                ...
                BufetHelpers(requireContext()).makeInvisible(arrayListOf(binding.filterNavigation, binding.mainDisplayTitle, binding.advertiseRecycler, binding.restaurantsRecycler))
            } else {
                BufetHelpers(requireContext()).makeVisible(arrayListOf(binding.filterNavigation, binding.mainDisplayTitle, binding.advertiseRecycler, binding.restaurantsRecycler))
